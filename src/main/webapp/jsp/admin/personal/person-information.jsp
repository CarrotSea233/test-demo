<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
	...
	<body>
		...
		<%  Login loginUser=CookieUtil.getCookie(request);
			...
			Admin admin = null;
			try { admin=adminMapper.getAdminByUserId(loginUser.getUserId()); }
			catch (Exception e) 
			{ e.printStackTrace(); }
				...
				<div class="layui-side layui-bg-black">
					<div class="layui-side-scroll">
						<ul class="layui-nav layui-nav-tree">
							<li class="layui-nav-item" style="background-color: #16baaa;"><a
									href="/test-demo/jsp/admin/personal/person-information.jsp" style="color: white;">个人信息</a></li>
					...
					<div style="padding: 15px;">
						<div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
							<div style="padding: 15px; max-width: 500px;">
								<form class="layui-form layui-form-pane" action="/test-demo/jsp/admin/personal/person-update.jsp">
									<div class="layui-form-item" pane>
										<label class="layui-form-label">姓名</label>
										<div class="layui-input-block">
											<input type="text" name="userName" class="layui-input"
												value="<%=admin.getUserName()%>" disabled>
										</div>
									</div>
									<div class="layui-form-item" pane>
										...
										<div class="layui-input-block">
											<input type="text" name="gender" class="layui-input"
												value="<%=admin.getGender()%>" disabled>
										</div>
									</div>
									<div class="layui-form-item" pane>
										...
										<div class="layui-input-block">
											<input type="text" name="age" class="layui-input"
												value="<%=admin.getAge()%>" disabled>
										</div>
									</div>
									<div class="layui-form-item">
										<button class="layui-btn" lay-submit lay-filter="demo2">设置</button>
									</div>
								</form>
							</div>
						</div>
