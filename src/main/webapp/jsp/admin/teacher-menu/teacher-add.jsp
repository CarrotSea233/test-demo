                        ...
                        <ul class="layui-nav layui-nav-tree">
                            ...
                            <li class="layui-nav-item layui-nav-itemed">
                                ...
                                <dl class="layui-nav-child">
                                    ...
                                    <dd style="background-color: #16baaa;"><a href="/test-demo/jsp/admin/teacher-menu/teacher-add.jsp"
                                            style="color: white;">教师添加</a></dd>
                                </dl>
                            </li>
                    ...
                    <div style="padding: 15px;">
                        <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                            <div style="padding: 15px; max-width: 500px;">
                                <form class="layui-form layui-form-pane" action="/test-demo/admin/add-teacher-servlet">
