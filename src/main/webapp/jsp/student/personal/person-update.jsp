				...
				<div style="padding: 15px;">
					<div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
						<div style="padding: 15px; max-width: 500px;">
							<form class="layui-form layui-form-pane" action="/test-demo/student/update-person-servlet">   

                                <div class="layui-form-item" pane>
                                    <label class="layui-form-label">学号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="studentId" class="layui-input" value="<%=student.getStudentId()%>" readonly>
                                    </div>
                                </div>
                                <div class="layui-form-item" pane>
