<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
    ...
    <body>
        ...
        <%
			...
			List<Question> questions = questionMapper.listQuestionsExceptTheExamPart(examId);
			sqlSession.close();
            ...
            <div class="layui-body">
                <div style="padding: 15px;">
                    <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                        <div style="padding: 15px;">
                            <form class="layui-form layui-form-pane" action="/test-demo/teacher/exam-add-question-servlet" method="post">
                                <div class="layui-form-item">
                                    <div class="layui-inline" pone>
                                        <label class="layui-form-label">作业ID</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="examId" value="<%=exam.getExamId()%>" readonly
                                                class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline" pone>
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="examName" value="<%=exam.getExamName()%>" readonly
                                                class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="float: right;">
                                        <button class="layui-btn" lay-submit>添加试题</button>
                                        <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                                    </div>
                                </div>

                                <div class="layui-form-item layui-form-text">
                                    <label class="layui-form-label" style="text-align: center;">选择题目</label>
