                ...
                <div class="layui-body">
                    <div style="padding: 15px;">
                        <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                            <div style="padding: 15px;">
                                <form class="layui-form layui-form-pane" action="/test-demo/teacher/update-exam-servlet">
                                    ...
                                    <div class="layui-form-item">
                                        <div class="layui-form-inline" pane>
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="examName" class="layui-input" value="<%=exam.getExamName()%>">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <% 
                                                        for(int i=0; i<questions.size(); i++) {
                                                            out.print("<tr>"+
                                                                ...
                                                                "<td>"+"<div class='layui-input-inline'><input type='text' name='score"+questions.get(i).getQuestionId()+"' class='layui-input' value='"+questions.get(i).getQuestionScore()+"'></div>"+"</td>"+
                                                                ...
                                                                "<td style='text-align: center;'><button type='button' class='layui-btn layui-btn-danger' onclick='delTheExamQuestion("+ questions.get(i).getReqId() +","+examId+")'>删除</button></td>"+
                                                                "</tr>");
                                                        } 
                                                    %>
                                                </tbody>
