<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
	...
	<body>
		...
		<%  Login loginUser=CookieUtil.getCookie(request);
            ...
            TeacherView teacher = teacherMapper.getTeacherByUserId(loginUser.getUserId());
            sqlSession.close();
		%>
			...
			<div class="layui-layout layui-layout-admin">
                ...
                <div class="layui-header">
                    <!-- logo -->
                    <div class="layui-logo layui-bg-black"><a href="/test-demo/jsp/teacher/teacher.jsp" style="color: white;">教师</a></div>
                ...
                <div class="layui-side layui-bg-black">
                    <div class="layui-side-scroll">
                        <ul class="layui-nav layui-nav-tree">
                            <li class="layui-nav-item" style="background-color: #16baaa;"><a href="/test-demo/jsp/teacher/personal/person-information.jsp" style="color: white;">个人信息</a></li>
					...
					<div style="padding: 15px;">
						<div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
							<div style="padding: 15px; max-width: 500px;">
								<form class="layui-form layui-form-pane" action="/test-demo/jsp/teacher/personal/person-update.jsp">
                                    
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">工号</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="jobId" class="layui-input" value="<%=teacher.getJobId()%>" disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">职位</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="identity" class="layui-input" value="<%=teacher.getIdentity()%>" disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">姓名</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="userName" class="layui-input" value="<%=teacher.getUserName()%>" disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">性别</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="gender" class="layui-input" value="<%=teacher.getGender()%>" disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">年龄</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="age" class="layui-input" value="<%=teacher.getAge()%>" disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="entryYear" id="date" lay-verify="date"
                                                placeholder="yyyy-MM-dd" class="layui-input" value="<%=teacher.getEntryYear()%>" disabled>
                                        </div>
                                    </div>
