                    ...
                    <div style="padding: 15px;">
                        <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                            <div style="padding: 15px; max-width: 500px;">
                                <form class="layui-form layui-form-pane" action="/test-demo/teacher/update-question-servlet">
                                    ...
                                    <div class="layui-form-item" pane>
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="questionTypes" class="layui-input" value="<%=question.getQuestionTypes()%>" readonly>
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">题目名称</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="questionName" class="layui-input" value="<%=question.getQuestionName()%>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">题目描述</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="questionDescription" class="layui-input" value="<%=question.getQuestionDescription()%>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">选项A</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="choiceA" class="layui-input" value="<%=question.getChoiceA()%>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">选项B</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="choiceB" class="layui-input" value="<%=question.getChoiceB()%>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">选项C</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="choiceC" class="layui-input" value="<%=question.getChoiceC()%>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">选项D</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="choiceD" class="layui-input" value="<%=question.getChoiceD()%>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item" pane>
                                        <label class="layui-form-label">答案</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="solution" class="layui-input" value="<%=question.getSolution()%>">
                                        </div>
                                    </div>
