<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
    ...
    <body>
        ...
        <%
            ...
            Test test = new Test(testId, testName, className);
            
			SqlSession sqlSession = MyBatisUtil.getSqlSession();
			TestMapper testMapper = sqlSession.getMapper(TestMapper.class);
			List<Test> tests = testMapper.findTests(test);
			sqlSession.close();
            ...
            <div class="layui-body">
                <div style="padding: 15px;">
                    <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                        <div style="padding: 15px;">
                            <form class="layui-form layui-row layui-col-space16" action="/test-demo/jsp/teacher/score/score-view.jsp">
                            ...
                            <table class="layui-table" style="text-align: center;">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;">作业布置ID</th>
                                    ...
                                    <% 
                                        for(int i=0; i<tests.size(); i++) {
                                            out.print("<tr>"+
                                                ...
                                                "<td><button type='button' class='layui-btn' onclick='toTheTestScore("+ tests.get(i).getTestId()+")'>查看</button></td>"+
                                                "</tr>");
                                        } 
                                    %>
                                </tbody>
