<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
			...
			<div class="layui-side layui-bg-black">
				<div class="layui-side-scroll">
					<ul class="layui-nav layui-nav-tree">
						<li class="layui-nav-item"><a href="/test-demo/jsp/teacher/personal/person-information.jsp">个人信息</a></li>
	...
	<script src="/test-demo/utils/layui/layui.js"></script>
		<script>
			...
			window.location.href = '/test-demo/jsp/teacher/test/test-view.jsp';
