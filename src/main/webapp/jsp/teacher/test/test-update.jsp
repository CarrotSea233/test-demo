            ...
            <div class="layui-body">
                <div style="padding: 15px;">
                    <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                        <div style="padding: 15px;">
                            <form class="layui-form layui-form-pane" action="/test-demo/teacher/update-test-servlet">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-form-inline" pane>
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="testName" class="layui-input" value="<%=test.getTestName()%>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-form-inline" pane>
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="datetime-local" name="testStartTime" class="layui-input" value="<%=test.getTestStartTime()%>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-form-inline" pane>
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="datetime-local" name="testEndTime" class="layui-input" value="<%=test.getTestEndTime()%>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-form-inline" pane>
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="className" class="layui-input" value="<%=test.getClassName()%>">
                                        </div>
                                    </div>
                                </div>
