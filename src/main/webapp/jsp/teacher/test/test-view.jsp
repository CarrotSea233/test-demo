            ...
            <div class="layui-body">
                <div style="padding: 15px;">
                    <div class="layui-panel" style="min-height: calc(100vh - 60px - 32px);">
                        <div style="padding: 15px;">
                            <form class="layui-form layui-row layui-col-space16" action="/test-demo/jsp/teacher/test/test-view.jsp">
                                    ...
                                    <% 
                                        for(int i=0; i<tests.size(); i++) {
                                            out.print("<tr>"+
                                                ...
                                                "<td><button type='button' class='layui-btn' onclick='toTheTest("+ tests.get(i).getTestId() +")'>查看</button></td>"+
                                                "<td><button type='button' class='layui-btn layui-btn-danger' onclick='delTheTest("+ tests.get(i).getTestId() +")'>删除</button></td>"+
                                                "</tr>");
                                        } 
                                    %>
                                </tbody>
